...
> 역사적 기록: 아래는 이전 중심 구역 재구성 자료입니다. 최신 앱은 이 문서의 69,716동·257² DEM·500m 패딩·래스터를 사용하지 않습니다. 현재 25개 구 확장과 명시적 추정 정책은 [서울 전역 자료](full-seoul-data.md)를 참고하세요. 아래의 “현재”는 당시 구현을 뜻합니다.
