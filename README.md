...
이 브랜치는 실제 미터 좌표·DEM 지형·Blender 랜드마크5종·원형 윤곽을 보존한 건물69,716동으로 재구성했습니다. 기존 공개 배포와 구분하며, [모델·높이·지형 출처와 추정 범위](docs/reconstruction.md)를 확인하세요. 사진 측량 또는 현장과 동일한 복제품이 아닙니다.
